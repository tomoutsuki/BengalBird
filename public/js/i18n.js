...
const I18n = (() => {
    ...
    const strings = {
        en: {
            ...
            select_images_multi: 'Select the correct images for both words:',
            ...
            section_letters: 'New Letters',
            section_vocabulary: 'Key Vocabulary',
            // Dictionary practice
            practice_word: 'Practice this word',
            practice_easy: 'EASY',
            practice_normal: 'NORMAL',
            practice_hard: 'HARD',
            practice_easy_desc: 'Reconstruct with letter keys',
            practice_normal_desc: 'Type romanization',
            practice_hard_desc: 'Type Bengali directly',
            practice_title: 'Practice Mode',
            practice_check: 'Check',
            practice_correct: 'Correct!',
            practice_try_again: 'Try again',
            practice_reset: 'Reset',
            practice_back: 'Back to Dictionary',
            practice_instructions_easy: 'Tap the letters to spell the word:',
            practice_instructions_normal: 'Type the romanization of this word:',
            practice_instructions_hard: 'Type this word in Bengali:',
            practice_great: 'Well done!',
        },
        ja: {
            menu_title: 'レッスン一覧',
            settings_title: '設定',
            ...
            select_images_multi: '両方の単語に合う画像を選んでください：',
            ...
            // Section popup
            section_details: 'セクション詳細',
            section_letters: '新しい文字',
            section_vocabulary: '主な語彙',
            // Dictionary practice
            practice_word: 'この単語を練習',
            practice_easy: 'かんたん',
            practice_normal: 'ふつう',
            practice_hard: 'むずかしい',
            practice_easy_desc: '文字キーで組み立て',
            practice_normal_desc: 'ローマ字を入力',
            practice_hard_desc: 'ベンガル語で直接入力',
            practice_title: '練習モード',
            practice_check: '確認',
            practice_correct: '正解！',
            practice_try_again: 'もう一度',
            practice_reset: 'リセット',
            practice_back: '辞書に戻る',
            practice_instructions_easy: '文字をタップして単語を入力：',
            practice_instructions_normal: 'この単語のローマ字を入力：',
            practice_instructions_hard: 'この単語をベンガル語で入力：',
            practice_great: 'よくできました！',
        }
    };
